...
def main():
    ...
    with h5py.File(args.input, "r") as f_in, h5py.File(output, "w") as f_out:
        ...
        # Write memory of original file into the light file
        # This lets later scripts recover the full-image HDF5.
        f_out.attrs["original_file_path"] = input_abs
    ...
    print(f"Original full-data file path stored as attribute 'original_file_path' = {input_abs!r}")
